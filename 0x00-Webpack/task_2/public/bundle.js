...
(0, _jquery["default"])(document).ready(function () {
  ...
  (0, _jquery["default"])('body').prepend('<div id="logo"></div>');

  // Add the rest of the content
  (0, _jquery["default"])('body').append('<p>ALX Dashboard</p>');
  ...
  (0, _jquery["default"])('body').append('<p>Copyright - ALX</p>');

  // Counter functionality
  var count = 0;
  function updateCounter() {
    count++;
    (0, _jquery["default"])('#count').text("".concat(count, " clicks on the button"));
  }

  // Add debounced click event to the button
  (0, _jquery["default"])('button').on('click', _lodash["default"].debounce(updateCounter, 300));
});
})();
